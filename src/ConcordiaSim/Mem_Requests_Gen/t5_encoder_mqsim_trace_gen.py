...
convert_csv_to_trace('t5_encoder_timing.csv', 'mqsim_t5_encoder.trace')

# Split the generated trace file into read and write trace files
split_trace_file('mqsim_t5_encoder.trace', 'mqsim_t5_encoder_write.trace', 'mqsim_t5_encoder_read.trace')
