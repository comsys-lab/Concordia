...
convert_csv_to_trace('chinchilla_timing.csv', 'mqsim_chinchilla.trace')

# Split the generated trace file into read and write trace files
split_trace_file('mqsim_chinchilla.trace', 'mqsim_chinchilla_write.trace', 'mqsim_chinchilla_read.trace')
