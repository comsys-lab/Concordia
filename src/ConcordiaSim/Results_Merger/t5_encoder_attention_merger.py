...
for _ in range(127):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 70499 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 70499)
        
        # Rule 4: Add 70499 to the second column
        columns[1] = str(int(columns[1]) + 70499)
