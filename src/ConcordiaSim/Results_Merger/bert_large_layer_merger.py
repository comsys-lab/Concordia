...
input_file = 'bert_large_1layer.csv'
output_file = 'b.csv'
...
for _ in range(23):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 10194336 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 10194336)
        
        # Rule 4: Add 10194336 to the second column
        columns[1] = str(int(columns[1]) + 10194336)
