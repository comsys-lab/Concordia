...
for _ in range(95):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 1379532 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 1379532)
        
        # Rule 4: Add 1379532 to the second column
        columns[1] = str(int(columns[1]) + 1379532)
