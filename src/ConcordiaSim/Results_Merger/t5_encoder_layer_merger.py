...
current_rows = data_lines[0:1162]
all_modified_rows = []
...
for _ in range(23):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 14041456 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 14041456)
        
        # Rule 4: Add 14041456 to the second column
        columns[1] = str(int(columns[1]) + 14041456)
