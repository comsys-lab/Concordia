...
for _ in range(95):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 155654208 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 155654208)
        
        # Rule 4: Add 155654208 to the second column
        columns[1] = str(int(columns[1]) + 155654208)
