#Modify file name, number in line 25, and number in line 31.
...
for _ in range(15):
    ...
    for line in current_rows:
        ...
        # Rule 3: Add 486243 to the first column, unless the value is -1
        if int(columns[0]) != -1:
            columns[0] = str(int(columns[0]) + 486243)
        
        # Rule 4: Add 486243 to the second column
        columns[1] = str(int(columns[1]) + 486243)
