    ...
    def run_simulation_single_layer(self, layer_id=0):
        ...
        for grid_row_id in range(self.grid_rows):
            for grid_col_id in range(self.grid_cols):
                ...
                ##############################################################                                
                # Write the traces
                top_path = '../output_files/scalesim_results/t5_encoder_attention_head_bwd/trace'
                simname= 't5_encoder_attention_head_bwd' #실험명
...
def Get_OFMAP_offchip_writes(toponame, batch):
    ...
    if mnk_flag:
        topofile = '../input_files/topologies/pathways/t5_encoder/'+toponame+'.csv'
    else:
        topofile = '../input_files/topologies/pathways/t5_encoder/'+toponame+'.csv' 
...
if __name__ == '__main__':
    ...
    for gds in x_labels:
        ...
        repdir = '../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory('../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_Detail')
        ...
        repdir2='../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory('../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_Compact')
        ...
        repdir3='../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_perPod/'+toponame #./reports_compact/simname_toponame
        createDirectory('../output_files/scalesim_results/t5_encoder_attention_head_bwd/Scaleout_perPod')
