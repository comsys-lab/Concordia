    ...
    def run_simulation_single_layer(self, layer_id=0):
        ...
        for grid_row_id in range(self.grid_rows):
            for grid_col_id in range(self.grid_cols):
                ...
                ##############################################################                                
                # Write the traces
                # top_path = '../../output_files/scalesim_results/palm_ff1_bwd/trace'
                # simname= 'palm_ff1_bwd' #실험명
...
if __name__ == '__main__':
    ...
    for gds in x_labels:
        ...
        repdir = '../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_Detail/'+toponame #./reports_detail/simname_toponame
        createDirectory('../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_Detail')
        ...
        repdir2='../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_Compact/'+toponame #./reports_compact/simname_toponame
        createDirectory('../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_Compact')
        ...
        repdir3='../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_perPod/'+toponame #./reports_compact/simname_toponame
        createDirectory('../../output_files/scalesim_results/palm_ff1_bwd/Scaleout_perPod')
